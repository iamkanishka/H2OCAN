...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  {position: 2, name: 'Helium', weight: 4.0026, symbol: 'Ondelivery'},
  {position: 3, name: 'Lithium', weight: 6.941, symbol: 'delivered'},
  {position: 4, name: 'Beryllium', weight: 9.0122, symbol: 'Ondelivery'},
  {position: 5, name: 'Boron', weight: 10.811, symbol: 'Ordered'},
  {position: 6, name: 'Carbon', weight: 12.0107, symbol: 'Ondelivery'},
  {position: 7, name: 'Nitrogen', weight: 14.0067, symbol: 'Undelivered'},
